...
import com.ding.favorites.domain.undecitioned.UserIsFollow;
...
public interface LookAroundService {
     ...
     * @return
     */
    public List<CollectSummary> queryCollectExplore(PageInfo pageInfo, Long userId, String category);
